...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Breezecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.breezecoin.org", "seed.breezecoin.org"},
    {"seed2.breezecoin.org", "seed2.breezecoin.org"},
    {"seed3.breezecoin.org", "seed3.breezecoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"breezecoin.org", "testnet-seed.breezecoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Breezecoin is probably already running."), addrBind.ToString().c_str());
        else
